...
do_describe(?DDL{fields = FieldSpecs,
    ...
    ColumnNames = [<<"Column">>, <<"Type">>, <<"Is Null">>, <<"Primary Key">>, <<"Local Key">>, <<"Order">>, <<"Interval">>, <<"Unit">>],
    ...
    Rows =
        [[Name, list_to_binary(atom_to_list(Type)), Nullable,
          ...
          column_lk_position_or_blank(Name, LKSpec), describe_field_order(Name, LKSpec)] ++
    ...
    ?assertMatch(
       {ok, {_, _,
             [[<<"f">>, <<"varchar">>,   false, 1,  1,   <<"ASC">>, [], []],
              ...
              [<<"t">>, <<"timestamp">>, false, 3,  3,   <<"ASC">>, 15, <<"m">>],
              [<<"w">>, <<"sint64">>,    false, [], [],  <<"ASC">>, [], []],
              [<<"p">>, <<"double">>,    true,  [], [],  <<"ASC">>, [], []]]}},
       Res).
